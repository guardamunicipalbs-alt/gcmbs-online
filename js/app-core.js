...
import {AuthenticatedProvider} from './data-provider.js?v=100080';
import {MODULOS_GCMBS} from './access-catalog.js?v=100080';
import {PRIMARY_ENTITY,DEDICATED_VIEW,canonicalModule} from './communication-contract.js?v=100080';
import {configurarPushNativo} from './native-push.js';

const $=id=>document.getElementById(id);
const GCMBS_APP_VERSION='10.0.80';
const GCMBS_APP_VERSION_CODE=80;
...
function renderRelatoriosInstitucionais(){
  ...
  if(status)status.textContent=`${dados.length} registro(s) institucional(is) · fonte: réplica integral do Desktop 10.0.80`;
...
if('serviceWorker' in navigator){navigator.serviceWorker.register('./sw.js?v=100080',{updateViaCache:'none'}).catch(()=>{});}
