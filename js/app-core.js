...
import {AuthenticatedProvider} from './data-provider.js?v=100084';
import {MODULOS_GCMBS} from './access-catalog.js?v=100084';
import {PRIMARY_ENTITY,DEDICATED_VIEW,canonicalModule} from './communication-contract.js?v=100084';
import {configurarPushNativo} from './native-push.js';

const $=id=>document.getElementById(id);
const GCMBS_APP_VERSION='10.0.84';
const GCMBS_APP_VERSION_CODE=84;
...
function renderRelatoriosInstitucionais(){
  ...
  if(status)status.textContent=`${dados.length} registro(s) institucional(is) · fonte: réplica integral do Desktop 10.0.84`;
...
if('serviceWorker' in navigator){navigator.serviceWorker.register('./sw.js?v=100084',{updateViaCache:'none'}).catch(()=>{});}
