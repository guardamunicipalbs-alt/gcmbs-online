...
import {MODULOS_GCMBS} from './access-catalog.js?v=100075';
import {PRIMARY_ENTITY,DEDICATED_VIEW,canonicalModule} from './communication-contract.js?v=100075';
import {configurarPushNativo} from './native-push.js';

const $=id=>document.getElementById(id);
const GCMBS_APP_VERSION='10.0.75';
const GCMBS_APP_VERSION_CODE=75;
...
function renderRelatoriosInstitucionais(){
  ...
  if(status)status.textContent=`${dados.length} registro(s) institucional(is) · fonte: réplica integral do Desktop 10.0.75`;
...
if('serviceWorker' in navigator){navigator.serviceWorker.register('./sw.js?v=100075',{updateViaCache:'none'}).catch(()=>{});}
