// GCMBS 10.0.85 - compatibilidade com camadas legadas
...
(function(){
  const corrigir=v=>String(v??'').replace(/10\.0\.(?:62|68|69|76|78|79|80|81|82|83|84)/g,'10.0.85');
  ...
  console.info('[GCMBS] Proteção de versão 10.0.85 ativa');
})();
