// GCMBS 10.0.73 - compatibilidade com camadas legadas
...
(function(){
  const corrigir=v=>String(v??'').replace(/10\.0\.(?:62|68|69)/g,'10.0.73');
  ...
  console.info('[GCMBS] Proteção de versão 10.0.73 ativa');
})();
