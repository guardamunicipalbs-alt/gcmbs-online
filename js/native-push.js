// GCMBS 10.0.74 — integração Push nativa autocontida.
  ...
  try{
    ...
    await Push.addListener('registration',async token=>{
      try{
        ...
        await provider.registerPushToken(token.value,{platform:'android',device_id:localStorage.getItem(deviceKey)||'',app_version:'10.0.74'});
