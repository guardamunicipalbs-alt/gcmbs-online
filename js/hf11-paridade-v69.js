// GCMBS 10.0.70 — paridade de impressão Desktop, Online e App.
...
(function(){
  ...
  function prepararImpressao(){
    ...
    blocos.forEach((bloco,i)=>{
      ...
      const footer=document.createElement('footer');footer.textContent=`GCMBS 10.0.70 · Página ${i+1} de ${blocos.length}`;pagina.appendChild(footer);
