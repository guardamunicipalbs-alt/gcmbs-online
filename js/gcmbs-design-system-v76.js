 ...
 * V141: pacote consolidado Online/App — permissões, login e gestão de permutas.
 */
(()=>{
  'use strict';
  ...
  loadStyle('css/gcmbs-v131-login-mobile-online.css?v=100141','gc131-login-mobile');
  loadStyle('css/gcmbs-v133-login-hero-fix.css?v=100141','gc133-login-hero-fix');
  loadStyle('css/gcmbs-login-hero-fallback-v140.css?v=100141','gc140-login-fallback');
  ...
  loadScript('js/gcmbs-v131-login-mobile-online.js?v=100141','gc131-login-mobile');
  loadScript('js/gcmbs-login-hero-fallback-v140.js?v=100141','gc140-login-fallback');
  loadScript('js/gcmbs-bank-command-v133.js?v=100141','gc133-bank-command');
  loadScript('js/gcmbs-bank-filter-v136.js?v=100141','gc136-bank-filter');
  loadScript('js/gcmbs-permuta-confirm-v136.js?v=100141','gc136-permuta-confirm');
  loadScript('js/gcmbs-dashboard-dedupe-v136.js?v=100141','gc136-dashboard-dedupe');
  loadScript('js/gcmbs-bank-mobile-fixes-v137.js?v=100141','gc137-bank-mobile-fixes');
  loadScript('js/gcmbs-mobile-permissions-v140.js?v=100141','gc140-mobile-permissions');
  loadScript('js/gcmbs-permuta-admin-fixes-v141.js?v=100141','gc141-permuta-admin');
})();
