// GCMBS 10.0.71 - Quadro Operacional com efetivo completo.
...
import('./hf10-r18-frota-sync.js?v=100071')
...
import('./hf10-r21-form-parity.js?v=100071')
  .catch(err=>console.warn('[GCMBS] HF10 R21 falha ao carregar paridade visual',err));

console.info('[GCMBS] 10.0.71 Quadro com efetivo completo ativo');
