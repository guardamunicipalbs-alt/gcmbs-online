// GCMBS 10.0.74 - Quadro Operacional com efetivo completo.
...
import('./hf10-r18-frota-sync.js?v=100074')
...
import('./hf10-r21-form-parity.js?v=100074')
  .catch(err=>console.warn('[GCMBS] HF10 R21 falha ao carregar paridade visual',err));

console.info('[GCMBS] 10.0.74 Quadro com efetivo completo ativo');
