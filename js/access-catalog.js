import './stability-hotfix-v62.js?v=100069';
import './sync-button-hotfix-v62.js?v=100069';
...
const carregarExtensoesOpcionais=()=>{
  ...
  setTimeout(()=>importarOpcional('./p0-online-workflows.js?v=100069','P0'),400);
  setTimeout(()=>carregarModuloIndependente('./folha-online-v62.js?v=100069','gcmbsFolhaV62Module','Folha'),900);
};
