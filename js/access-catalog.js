import './stability-hotfix-v62.js?v=100070';
import './sync-button-hotfix-v62.js?v=100070';
...
const carregarExtensoesOpcionais=()=>{
  ...
  setTimeout(()=>importarOpcional('./p0-online-workflows.js?v=100070','P0'),400);
  setTimeout(()=>carregarModuloIndependente('./folha-online-v62.js?v=100070','gcmbsFolhaV62Module','Folha'),900);
};
