export const MODULOS_GCMBS = [
  ...
  {id:'permutas',nome:'Permutas',descricao:'Solicitação e análise de troca ou assunção de serviço',mobile:'extras'},
  {id:'eventos_extra',nome:'Serviço Extra por Evento',descricao:'Serviços extraordinários vinculados a eventos'},
  ...
  {id:'manutencao_viaturas',nome:'Manutenção de Viaturas',descricao:'Baixa e retorno da frota'},
  {id:'abastecimento_viaturas',nome:'Abastecimento',descricao:'Histórico de consumo da frota'},
