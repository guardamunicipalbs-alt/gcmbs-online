const CACHE='gcmbs-mobile-100065-hf8r4-utf8';
const AUDIT_FIX='<script type="module" src="./js/v62-auditoria-app-fix.js?v=20260823hf8r4"></script>';
    ...
    try{
      ...
      if((e.request.mode==='navigate'||type.includes('text/html'))&&r.ok){
        ...
        if(html.includes('v62-auditoria-app-fix.js')){
          html=html.replace(/js\/v62-auditoria-app-fix\.js\?v=[^"']+/g,'js/v62-auditoria-app-fix.js?v=20260823hf8r4');
        }else{
